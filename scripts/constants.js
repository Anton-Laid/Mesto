...
const likeContainer = document.querySelectorAll('.photo__container');
const buttonLike = cardTemplate.querySelector('.photo__like');
const counterButtonLike = document.querySelector('.photo__like-count');
